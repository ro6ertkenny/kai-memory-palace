...
> This article explores monitoring storage performance using tools like iostat and pidstat to diagnose and manage storage device issues.
...
2. When large volumes of data are transferred during each operation (visible in the kB\_read/kB\_wrn fields).
...
After a while, you may notice a sudden increase in TPS and kB\_wrn/s for devices like dm-0 and sda. For example:
...
<CardGroup>
  <Card title="Watch Video" icon="video" cta="Learn more" href="https://learn.kodekloud.com/user/courses/linux-foundation-certified-system-administrator-lfcs/module/cfd9ce0f-72d4-40ec-97cd-875899512ff2/lesson/9ba247d2-68fd-4b85-aacc-c98d0dd1a6db" />
</CardGroup>
